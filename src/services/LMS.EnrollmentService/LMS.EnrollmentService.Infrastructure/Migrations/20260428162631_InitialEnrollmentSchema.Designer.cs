...
namespace LMS.EnrollmentService.Infrastructure.Migrations
{
    ...
    [Migration("20260428162631_InitialEnrollmentSchema")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LMS.EnrollmentService.Domain.Entities.Enrollment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("TenantId", "CourseId", "Status")
                        .HasDatabaseName("ix_enrollments_tenant_id_course_id_status");

                    b.HasIndex("TenantId", "UserId", "CourseId")
                        .IsUnique()
                        .HasDatabaseName("ix_enrollments_tenant_id_user_id_course_id")
                        .HasFilter("status = 0");

                    b.HasIndex("TenantId", "UserId", "Status")
                        .HasDatabaseName("ix_enrollments_tenant_id_user_id_status");
            ...
            modelBuilder.Entity("MassTransit.EntityFrameworkCoreIntegration.InboxState", b =>
                {
                    ...
                    b.ToTable("inbox_state", "enrollments");
                });
            ...
            modelBuilder.Entity("MassTransit.EntityFrameworkCoreIntegration.OutboxMessage", b =>
                {
                    ...
                    b.ToTable("outbox_message", "enrollments");
                });
            ...
            modelBuilder.Entity("MassTransit.EntityFrameworkCoreIntegration.OutboxState", b =>
                {
                    ...
                    b.ToTable("outbox_state", "enrollments");
                });
