...
namespace LMS.ProgressService.Infrastructure.Migrations
{
    ...
    [Migration("20260428162642_InitialProgressSchema")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LMS.ProgressService.Domain.Entities.CourseProgress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<bool>("CourseCompletedEventPublished")
                        .HasColumnType("boolean")
                        .HasColumnName("course_completed_event_published");
                    ...
                    b.Property<int>("TotalRequiredLessons")
                        .HasColumnType("integer")
                        .HasColumnName("total_required_lessons");
                    ...
                    b.HasIndex("TenantId", "CourseId")
                        .HasDatabaseName("ix_course_progress_tenant_id_course_id");

                    b.HasIndex("TenantId", "UserId", "CourseId")
                        .IsUnique()
                        .HasDatabaseName("ix_course_progress_tenant_id_user_id_course_id");

                    b.ToTable("course_progress", "progress");
                });

            modelBuilder.Entity("LMS.ProgressService.Domain.Entities.LessonProgress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("TenantId", "UserId", "CourseId")
                        .HasDatabaseName("ix_lesson_progress_tenant_id_user_id_course_id");

                    b.HasIndex("TenantId", "UserId", "LessonId")
                        .IsUnique()
                        .HasDatabaseName("ix_lesson_progress_tenant_id_user_id_lesson_id");
            ...
            modelBuilder.Entity("MassTransit.EntityFrameworkCoreIntegration.InboxState", b =>
                {
                    ...
                    b.ToTable("inbox_state", "progress");
                });
            ...
            modelBuilder.Entity("MassTransit.EntityFrameworkCoreIntegration.OutboxMessage", b =>
                {
                    ...
                    b.ToTable("outbox_message", "progress");
                });
            ...
            modelBuilder.Entity("MassTransit.EntityFrameworkCoreIntegration.OutboxState", b =>
                {
                    ...
                    b.ToTable("outbox_state", "progress");
                });
