namespace LMS.AssessmentService.Api.Extensions;
...
internal static class ResultExtensions
{
    ...
    internal static IResult ProblemGone(string code, string detail) =>
        Results.Problem(title: "Gone", detail: detail, statusCode: 410,
            extensions: new Dictionary<string, object?> { ["code"] = code });
}
